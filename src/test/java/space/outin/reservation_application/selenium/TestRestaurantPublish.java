...
public class TestRestaurantPublish {
  ...
  @Test
  public void testRestaurantPublish() throws Exception {
    ...
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Create New Account'])[1]/following::input[1]")).sendKeys("se@test2.com");
    ...
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Restaurant Profile'])[1]/following::textarea[1]")).sendKeys("restaurant used for testing");
    ...
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Restaurant Profile'])[1]/following::input[3]")).sendKeys("25");
